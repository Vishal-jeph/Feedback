...
<style>
    ...
    .chat-box {background:#f9fafb; border-radius:12px; padding:12px; max-height:420px; overflow-y:auto;}
    .feedback-msg {background:#8291b0; padding:10px; border-radius:8px; margin:8px 0;}
